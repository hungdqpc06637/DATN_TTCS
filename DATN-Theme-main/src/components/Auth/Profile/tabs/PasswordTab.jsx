              ...
              <div className="sm:flex sm:space-x-[30px] items-center">
                ...
                <div className="w-[180px]">
                  <button
                    type="submit"
                    style={{
                      width: "100%",  // Đảm bảo nút chiếm toàn bộ không gian div
                      height: "50px", // Chiều cao cố định cho nút
                      borderRadius: "30px", // Bo góc
                      backgroundColor: "#1d1d1d", // Nền đen
                      color: "#fff", // Chữ trắng
                      ...
                      boxShadow: "0 4px 10px rgba(0, 0, 0, 0.15)", // Bóng đổ nhẹ
                    }}
                    onMouseOver={(e) => {
                      e.target.style.backgroundColor = "#333"; // Đổi màu khi hover
                      e.target.style.transform = "scale(1.05)"; // Phóng to nhẹ khi hover
                    }}
                    onMouseOut={(e) => {
                      e.target.style.backgroundColor = "#1d1d1d"; // Trở lại màu ban đầu
                      e.target.style.transform = "scale(1)"; // Khôi phục kích thước
                    }}
                  >
                    Cập nhật mật khẩu
                  </button>
                ...
                <button
                  ...
                  style={{
                    borderRadius: "30px", // Bo góc
                    backgroundColor: "#f1f1f1", // Nền xám nhạt
                    color: "#1d1d1d", // Màu chữ đen
                    padding: "12px 35px", // Padding hợp lý
                    fontSize: "16px", // Kích thước chữ vừa phải
                    fontWeight: "600", // Chữ đậm
                    transition: "background-color 0.3s ease, transform 0.2s ease", // Hiệu ứng
                  ...
                  onMouseOver={(e) => {
                    e.target.style.backgroundColor = "#ddd"; // Màu nền khi hover
                    e.target.style.transform = "scale(1.05)"; // Phóng to nhẹ khi hover
                  }}
                  onMouseOut={(e) => {
                    e.target.style.backgroundColor = "#f1f1f1"; // Trở lại màu nền cũ
                    e.target.style.transform = "scale(1)"; // Khôi phục kích thước ban đầu
                  }}
                >
                  Hủy bỏ
                </button>
          ...
          <div className="flex-1 sm:flex hidden justify-end">
            <div
              style={{
                ...
                width: "150px",
                height: "150px",
                marginRight: "100px", // Đẩy ra ngoài thêm nữa
                display: "flex",
                justifyContent: "center",
                alignItems: "center",
              }}
            >
              {/* Vòng tròn chính với gradient và hiệu ứng hover */}
              <div
                style={{
                  width: "100px",
                  height: "100px",
                  background: "linear-gradient(45deg, #00bcd4, #006db3)", // Thêm gradient cho vòng tròn
                  borderRadius: "50%",
                  display: "flex",
                  justifyContent: "center",
                  alignItems: "center",
                ...
                onMouseEnter={(e) => {
                  e.target.style.transform = "scale(1.1)"; // Khi hover vào sẽ phóng to một chút
                }}
                onMouseLeave={(e) => {
                  e.target.style.transform = "scale(1)"; // Khi rời khỏi sẽ trở về kích thước cũ
                }}
              >
                {/* Icon khóa */}
                <svg
                ...
                >
                  <path d="M12 2a5 5 0 0 0-5 5v3H5a1 1 0 0 0-1 1v10a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1V11a1 1 0 0 0-1-1h-2V7a5 5 0 0 0-5-5zm-3 5a3 3 0 1 1 6 0v3h-6V7zm-3 5h12v8H6v-8z" />
                </svg>
              </div>

              {/* Hiệu ứng nhịp đập với gradient nhẹ */}
              <div
                style={{
                  position: "absolute",
                  width: "120px",
