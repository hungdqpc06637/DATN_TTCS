    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .authorizeRequests(authorizeRequests -> 
                authorizeRequests
                    .requestMatchers("/api/login","/account/info", "/api/signup","/api/forgot-password","/api/verify-otp", "/api/update-password","/api/update-password-profile","/api/guest/products/search", "/api/user/payments/vnpay/callback" , "/api/send" , "/chat").permitAll()
